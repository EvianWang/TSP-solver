#CS486 Assignment2 Question1.4
#20559425 Ye Wang

###This is a python implementation of tsp problem(hill climbing)
###To compile the program use command python3 tsp_sideway.py
...
def hill_climbing():
    global current_state,step_counter,sideway_counter
    while True:
